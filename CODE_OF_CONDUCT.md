...
- Taking responsibility, apologizing to those affected by mistakes, and learning
  from the experience
...
project maintainers through a private communication channel available on the
hosting platform. If no private channel is available, open a minimal issue that
requests a private contact method without posting sensitive details publicly.
